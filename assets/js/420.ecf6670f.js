...
const db = {
  getConfig: () => (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_0__.c)().journey,
  clear,
...
const drawText = function(elem, textData) {
  return (0,_svgDrawCommon_5e1cfd1d_js__WEBPACK_IMPORTED_MODULE_2__.f)(elem, textData);
};
...
function drawActorLegend(diagram2) {
  const conf2 = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_0__.c)().journey;
  let yPos = 60;
...
const conf = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_0__.c)().journey;
...
const draw = function(text, id, version, diagObj) {
  ...
  (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_0__.i)(diagram2, height, width, conf2.useMaxWidth);
